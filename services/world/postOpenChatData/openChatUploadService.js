// services/openChatUploadService.js
const OpenChatDataTransformer = require('./utils/openChatDataTransformer');
...
class OpenChatUploadService {
  ...
  _createErrorResult(chatData, errorMessage) {
    ...
    try {
      ...
      console.error('Error transforming data for error result:', err.message);
    }
...
module.exports = new OpenChatUploadService();